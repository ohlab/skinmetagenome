...
# ===========================================================
def pathoscope_reassign(out_matrix, verbose, scoreCutoff, expTag, ali_format, ali_file, outdir, emEpsilon, maxIter, upalign, thetaPrior):
	...
	(initPi, pi, _, NU) = pathoscope_em(U, NU, genomes, maxIter, emEpsilon, verbose, thetaPrior )
...
# ===========================================================
def pathoscope_em(U, NU, genomes, maxIter, emEpsilon, verbose, thetaPrior):
	G = len(genomes)
	...
	for i in range(maxIter):  ## EM iterations--change to convergence 
		...
		thetap=thetaPrior # theta prior - may be updated later
